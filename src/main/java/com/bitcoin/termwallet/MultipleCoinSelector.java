...
public class MultipleCoinSelector implements CoinSelector {
	...
	private ArrayList<Address> addressesToQuery;

	public MultipleCoinSelector(ArrayList<Address> addressesToQuery) {
	...
	public ArrayList<Address> getAddressToQuery() {
		return addressesToQuery;
	}
    
	public void setAddressesToQuery(ArrayList<Address> toQuery) {
		addressesToQuery = toQuery;
	}
